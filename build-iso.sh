...
readonly TTY_PKGS="dialog libcaca tty-clock gotop castero micro fuzzypkg mutt sd stig aerc vpm pfetch gping telegram-tg xmirror void-docs void-docs-browse kmod setxkbmap network-manager-applet links unzip"
