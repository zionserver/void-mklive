...
readonly FLUXBOXWM_PKGS="$X_PKGS $IVDRI_PKGS lxdm fluxbox gvfs-afc gvfs-mtp gvfs-smb udisks2 network-manager-applet pcmanfm chromium volumeicon cbatticon lxtermianl"
